...
//   const switchB2bSubscriptionPlanFn = useSwitchB2bSubscriptionPlan({
//     config: {
//       onSuccess: (res) => {
...
//     switchB2bSubscriptionPlanFn?.mutateAsync({ id: router.query.id as string, data: { ...result, ...othersValues } });
//   };
...
//             <Button loading={switchB2bSubscriptionPlanFn?.isPending} type="primary" htmlType="submit">
//               Submit & Switch Plan
//             </Button>
//           </Form.Item>
//         </div>
