...
import { IProductCreate, IProductFilter, IProductResponse, IProductsResponse, IProductUpdate } from './interfaces';

const END_POINT: string = '/products';

export const ProductService = {
  NAME: END_POINT,
  async find(options: IProductFilter): Promise<IProductsResponse> {
    try {
  ...
  async update(payload: IProductUpdate): Promise<IProductResponse> {
    try {
  ...
  async softDelete(id: string): Promise<IProductResponse> {
    try {
